...
// leak and invites a pointless rotation. This fork carried the tri-state before
// the sync to upstream 9b2b88a, which restored upstream's two-valued version
// and with it the false alarm; see docs/RENAME.md on what a sync can drop.
