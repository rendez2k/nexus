...
// that fixes nothing. The sync to upstream 9b2b88a dropped this once; the
// import list above is what makes the next sync fail loudly instead.
test("protection state distinguishes an unreadable ACL from an exposed file", () => {
  ...
  try {
    ...
    writeFileSync(target, "openai_base_url = \"http://127.0.0.1:4202/_codex-router/x/v1\"\n");
